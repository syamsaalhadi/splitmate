            ...
            <section className="bg-surface-container-lowest rounded-xl p-8 shadow-sm">
              <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                <div>
                  ...
                  <h1 className="text-4xl font-extrabold tracking-tight text-on-surface mb-2 font-headline">Liburan Bali 2024</h1>
              ...
              <div className="mt-8 pt-8 border-t border-surface-container-highest flex flex-wrap gap-4">
                ...
                <button className="bg-secondary-container text-on-secondary-container px-6 py-3 rounded-full font-bold flex items-center gap-2 hover:opacity-90 transition-all transform active:scale-95 font-body">
              ...
              <div className="group bg-surface-container-low rounded-xl p-4 flex items-center justify-between hover:bg-surface-container-high transition-all">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-on-surface-variant font-medium font-body">Paid by <span className="text-primary">Alex</span> • 24 Oct 2024</p>
                  </div>
                </div>
              ...
              <div className="group bg-surface-container-low rounded-xl p-4 flex items-center justify-between hover:bg-surface-container-high transition-all">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-on-surface-variant font-medium font-body">Paid by <span className="text-primary">Citra</span> • 25 Oct 2024</p>
                  </div>
                </div>
                <div className="flex items-center gap-6">
                  <div className="text-right">
              ...
              <div className="group bg-surface-container-low rounded-xl p-4 flex items-center justify-between hover:bg-surface-container-high transition-all">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-on-surface-variant font-medium font-body">Paid by <span className="text-primary">Alex</span> • 26 Oct 2024</p>
                  </div>
                </div>
                <div className="flex items-center gap-6">
                  <div className="text-right">
            ...
            <section className="bg-surface-container-high rounded-2xl p-6 mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="bg-surface-container-lowest p-4 rounded-xl flex items-center justify-between">
                  ...
                  <button className="text-xs font-bold bg-primary text-white px-4 py-2 rounded-full hover:opacity-90 active:scale-95 transition-all font-body">Tandai Lunas</button>
                </div>
